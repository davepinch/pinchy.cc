...
- snippet: >-
  ...
  - proton
- snippet: >-
    Opposite electric charges are pulled towards one another by electrostatic force, so cations and anions attract each other and readily form [ionic compounds](/en.wikipedia.org/wiki/Ionic_compound).
  tags:
  - cation
  - anion
  - ionic compound
type: website
permalink: /en.wikipedia.org/wiki/Ion
