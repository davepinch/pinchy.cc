...
borders:
  ...
  - Missouri (Wikipedia)
  - Wisconsin (Wikipedia)
down the mississippi: Missouri (Wikipedia)
eastbound on interstate 90: Indiana (Wikipedia)
excerpt: >-
  **Illinois** (/ˌɪləˈnɔɪ/ *IL-ə-NOY*) is a state in the [Midwestern United States](/en.wikipedia.org/wiki/Midwestern_United_States/). [Chicago](/en.wikipedia.org/wiki/Chicago/) is its largest city, and the state's capital is Springfield; other major metropolitan areas include Metro East (of Greater St. Louis), Peoria and Rockford. Of the fifty U.S. states, Illinois has the fifth largest gross domestic product (GDP), the sixth largest population, and the 25th largest land area.
flag: Flag_of_Illinois.svg (commons.wikimedia.org)
