...
flag: Flag_of_Cyprus.svg (Wikimedia Commons)
island of: Mediterranean Sea (Wikipedia)
north of: Sinai Peninsula (Wikipedia)
part of:
  - Middle East (Wikipedia)
  - West Asia (Wikipedia)
retrieved: 2024-07-06
south of: Turkey (Wikipedia)
type: website
url: /en.wikipedia.org/wiki/Cyprus/
website: "https://en.wikipedia.org/wiki/Cyprus"
west of:
  - Syria (Wikipedia)
  - Lebanon (Wikipedia)
tags:
